...
export default function InterviewSessionPage() {
  ...
  useEffect(() => {
    ...
    const handleVisibilityChange = () => {
      if (document.hidden) {
        alert(
          "Tab switching detected. Interview will be submitted automatically."
        );
    ...
    const handleFullscreenChange = () => {
      if (!document.fullscreenElement) {
        alert(
          "Exiting fullscreen is not allowed during interview."
        );
  ...
  const finishInterview = () => {
    ...
    router.push(
      `/dashboard/interview/results/${params.sessionId}`
    );
  };
    ...
    <div className="max-w-5xl mx-auto py-6 space-y-6">
      ...
      <Card>
        <CardContent className="p-8 space-y-6">
          ...
          {/* ANSWER AREA */}
          <div className="rounded-2xl border bg-gray-50 p-4 min-h-[250px]">
